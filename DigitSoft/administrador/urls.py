...
urlpatterns = [
    ...
    # MÓDULOS DE CLIENTES
    # ========================================================================
    path('clientes/', views.lista_clientes, name='cliente_list'),
    path('clientes/crear/', views.cliente_create, name='cliente_create'),
    path('clientes/<int:pk>/editar/', views.cliente_update, name='cliente_update'),
    path('clientes/<int:pk>/eliminar/', views.cliente_confirm_delete, name='cliente_confirm_delete'),
    path('clientes/<int:pk>/detalle/', views.cliente_detail, name='cliente_detail'),
